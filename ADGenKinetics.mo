...
<p><i>This Modelica package is <u>free</u> software and the use is completely at <u>your own risk</u>; it can be redistributed and/or modified under the terms of the Modelica License 2. For license conditions (including the disclaimer of warranty) see <a href=\"modelica://Modelica.UsersGuide.ModelicaLicense2\">Modelica.UsersGuide.ModelicaLicense2</a> or visit <a href=\"http://www.modelica.org/licenses/ModelicaLicense2\">http://www.modelica.org/licenses/ModelicaLicense2</a>.</i> </p>
    ...
    package static "Interfaces for components consisting of a fixed number of connections"
      ...
      partial model Reaction1S "basic declaration of a reaction with one substrate"
        ADGenKinetics.Interfaces.ChemicalPort_S rc_S1 annotation(
          Placement(transformation(extent = {{-36, 50}, {-16, 70}}), iconTransformation(extent = {{-60, 72}, {-20, 112}})));
        annotation(
          Diagram(graphics),
      ...
      partial model Reaction2S "basic declaration of a reaction with two substrates"
        ...
        ADGenKinetics.Interfaces.ChemicalPort_S rc_S2 annotation(
          Placement(transformation(extent = {{-36, 50}, {-16, 70}}), iconTransformation(extent = {{20, 72}, {60, 112}})));
        annotation(
          Diagram(graphics),
          Icon(graphics = {Rectangle(extent = {{-100, 100}, {98, -100}}, lineColor = {0, 0, 255})}));
      end Reaction2S;
      ...
      partial model Reaction1P "basic declaration of a reaction with one product"
        ADGenKinetics.Interfaces.ChemicalPort_P rc_P1 annotation(
          Placement(transformation(extent = {{-50, 6}, {-10, 46}}), iconTransformation(extent = {{-58, -112}, {-18, -72}})));
      equation
      ...
      partial model Reaction2P "basic declaration of a reaction with two products"
        ...
        ADGenKinetics.Interfaces.ChemicalPort_P rc_P2 annotation(
          Placement(transformation(extent = {{-50, 6}, {-10, 46}}), iconTransformation(extent = {{22, -112}, {62, -72}})));
        annotation(
          Diagram(graphics),
          Icon(graphics = {Rectangle(extent = {{-100, 100}, {98, -100}}, lineColor = {0, 0, 255})}));
      end Reaction2P;
      ...
      partial model Reaction1A "interface for activating a reaction"
        ADGenKinetics.Interfaces.ModifierChemicalPort_A mc_A1 annotation(
          Placement(transformation(extent = {{-40, 80}, {0, 120}}), iconTransformation(extent = {{-120, -18}, {-80, 22}})));
        annotation(
          Icon(graphics));
      end Reaction1A;

      partial model Reaction1I "interface for inhibiting a reaction"
        ADGenKinetics.Interfaces.ModifierChemicalPort_I mc_I1 annotation(
          Placement(transformation(extent = {{-108, -12}, {-88, 8}}), iconTransformation(extent = {{76, -20}, {116, 20}})));
        annotation(
          Icon(graphics));
      end Reaction1I;
      annotation(
...
<p></p><h4>Package Content</h4><p></p>
      ...
      package Structure "Reaction Structure reversibility and dimension"
        class ReactionStructure "The structure of a reaction reversibility, molecularity and order"
          ...
          replaceable class Dimensionality = ADGenKinetics.Interfaces.dynamic.Dimension.ReactionDimension constrainedby ADGenKinetics.Interfaces.dynamic.Dimension.ReactionDimension;
...
<p><i>This Modelica package is <u>free</u> software and the use is completely at <u>your own risk</u>; it can be redistributed and/or modified under the terms of the Modelica License 2. For license conditions (including the disclaimer of warranty) see <a href=\"modelica://Modelica.UsersGuide.ModelicaLicense2\">Modelica.UsersGuide.ModelicaLicense2</a> or visit <a href=\"http://www.modelica.org/licenses/ModelicaLicense2\">http://www.modelica.org/licenses/ModelicaLicense2</a>.</i> </p>
      ...
      partial model NodeConnections "Metabolite connections to reactions wuth one connector only"
        ADGenKinetics.Interfaces.ChemicalPort rc "connection to any reaction " annotation(
          Placement(transformation(extent = {{-50, -50}, {50, 50}}), iconTransformation(extent = {{-114, -40}, {122, 154}})));
        ADGenKinetics.Interfaces.ModifierChemicalPort mc "connection to a modifier" annotation(
...
<p><i>This Modelica package is <u>free</u> software and the use is completely at <u>your own risk</u>; it can be redistributed and/or modified under the terms of the Modelica License 2. For license conditions (including the disclaimer of warranty) see <a href=\"modelica://Modelica.UsersGuide.ModelicaLicense2\">Modelica.UsersGuide.ModelicaLicense2</a> or visit <a href=\"http://www.modelica.org/licenses/ModelicaLicense2\">http://www.modelica.org/licenses/ModelicaLicense2</a>.</i> </p>
    ...
    package static "Node elements with a static number of interfaces and icons"
      ...
      annotation(
        Documentation(info = "<html><head></head><body><p>This subpackage contains implmentation for nodes, chemical substances, which provides a fixed number of connections to reactions. Typically the component <a href=\"ADGenKinetics.NodeElements.static.Node\">ADGenKinetics.NodeElements.static.Node</a> is the one which will be used at most. The component <a href=\"ADGenKinetics.NodeElements.static.ModifierNode\">ADGenKinetics.NodeElements.static.ModifierNode</a> is exactly the same and does not really provide additional functionalities (it is here only for backword compatibility reasons with older versions of this implementation). This component will mostly get removed in later versions. </p>
<p><br>Licensed under the Modelica License 2</p>
<p><br>Copyright ©&nbsp;<a href=\"ADGenKinetics.UserGuide.CopyRight\" style=\"font-size: 12px;\">ADGenKinetics.UserGuide.CopyRight</a></p>
<p><i>This Modelica package is <u>free</u> software and the use is completely at <u>your own risk</u>; it can be redistributed and/or modified under the terms of the Modelica License 2. For license conditions (including the disclaimer of warranty) see <a href=\"modelica://Modelica.UsersGuide.ModelicaLicense2\">Modelica.UsersGuide.ModelicaLicense2</a> or visit <a href=\"http://www.modelica.org/licenses/ModelicaLicense2\">http://www.modelica.org/licenses/ModelicaLicense2</a>.</i> </p>
</body></html>"));
